...
//    inputStrCmd = scanner.nextToken();
//    cout << "command " << inputStrCmd << endl;
//    inputStrValue = scanner.nextToken();
//    cout << "command " << inputStrValue << endl;
//    inputStrPriority = scanner.nextToken();
//    cout << "command " << inputStrPriority << endl;
//    if (inputStrCmd != "enqueue") {
...
void executeList(PriorityQueue pq, string cmd) {
    if (cmd != "list") {
        ...
        cout << pq.size() << " elements in the queue." << endl;
        //cout << "Queue: ";
        int sizeNum = pq.size();
        ...
        for (int i = 0; i < sizeNum; i++) {
            valueArr[i] = pq.peek();
            cout << "number " << i;
            cout << " peek " << valueArr[i];
            priorityArr[i] = pq.peekPriority();
            cout << " priority " << priorityArr[i] << endl;
            pq.dequeue();
            cout << valueArr[i] << " is dequeued" << endl;
        }
        cout << endl;
